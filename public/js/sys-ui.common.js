...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"26289d88-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=6829a352&
...
// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=6829a352&
...
var Appvue_type_script_lang_ts_App = /*#__PURE__*/function (_Vue) {
  ...
  _createClass(App, [{
    ...
    value: function handleWindowEvents() {
      $(window).on('notify', function (e) {
        var notify = e.detail;

        if (notify.type == types["LogType"].Debug) {
          $("#snackbar").addClass("visible").text(notify.message);
          setTimeout(function () {
            $("#snackbar").removeClass("visible");
          }, 3000);
        } else Appvue_type_script_lang_ts_main.updateRoot({
          notify: notify
        });
      }).on('question', function (e) {
        Appvue_type_script_lang_ts_main.updateRoot({
          question: e.detail
        });
        ...
        if (e.target.tagName == "A") {
          ...
          if (href) {
            ...
            if (main["glob"].dirty) {
              Object(main["notify"])(Object(main["$t"])('save-before'), types["LogType"].Warning);
              return;
            } // dirty page
    ...
    value: function mounted() {
      ...
      console.log("%c main started. %c version: ".concat(main["glob"].config.version, " %c"), 'background:#35495e ; padding: 1px; border-radius: 3px 0 0 3px;  color: #fff', 'background:#41b883 ; padding: 1px; border-radius: 0 3px 3px 0;  color: #fff', 'background:transparent');
    }
  }]);
...
var ItemMeta = function ItemMeta() {
  _classCallCheck(this, ItemMeta);
};

exports.ItemMeta = ItemMeta;

var ObjectDeclare = function ObjectDeclare() {
  _classCallCheck(this, ObjectDeclare);
};

exports.ObjectDeclare = ObjectDeclare;

var FunctionDeclare = function FunctionDeclare() {
  _classCallCheck(this, FunctionDeclare);
};
...
/* unused harmony export PropertyLabelMode */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "vueResetProperties", function() { return vueResetProperties; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getItemDec", function() { return getItemDec; });
...
function initState(res) {
  ...
  glob.headFuncs = []; // glob.form.toolbar = false;
...
function vueResetProperties(data, name, resetStatus) {
  var meta = data._;

  if (Array.isArray(data)) {
    if (resetStatus) {
      data.forEach(function (item) {
        return item._status = null;
      });
    }
  } else {
  ...
  var _iterator = Object(C_develop_sys_ui_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper__WEBPACK_IMPORTED_MODULE_20__[/* default */ "a"])(meta.dec.properties),
      _step;
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      if (data[prop.name] == null) {
        notify("Property '".concat(prop.name, "' is required."), _sys_src_types__WEBPACK_IMPORTED_MODULE_25__["LogType"].Warning); // if (!Array.isArray(glob.data[ref]))
...
function validate() {
  for (var ref in glob.data) {
    if (Array.isArray(glob.data[ref])) {
      var _iterator3 = Object(C_develop_sys_ui_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper__WEBPACK_IMPORTED_MODULE_20__[/* default */ "a"])(glob.data[ref]),
          _step3;
...
function handleResponse(res) {
  ...
  if (res.redirect) {
    ...
    notify(res.message, _sys_src_types__WEBPACK_IMPORTED_MODULE_25__["LogType"].Info); // resetToolbar();
    // history.pushState(null, null, "/");
  } else {
    initState(res);
  }
}
function setPropTextValue(meta, data, val) {
  var locale = getQs('e') || 'en';
  var oldValue = data[meta.name];
  ...
  if (meta.text && meta.text.multiLanguage) {
    if (locale) {
      ...
      if (Object(C_develop_sys_ui_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_21__[/* default */ "a"])(oldValue) == 'object') {
...
function getPropTextValue(meta, data) {
  ...
  if (Object(C_develop_sys_ui_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_21__[/* default */ "a"])(val) == 'object') {
    var locale = getQs('e') || 'en';
    return val[locale];
  } else {
    return val;
...
function question(questionId, message, options, select) {
  window.dispatchEvent(new CustomEvent('question', {
    detail: {
...
function load(href) {
  ...
  this.ajax(setQs('m', _sys_src_types__WEBPACK_IMPORTED_MODULE_25__["RequestMode"].partial, false, href), null, null, handleResponse, function (err) {
    return notify(err);
  });
}
function getItemDec(item) {
  if (!item || !item._) {
    return null;
  }
...
(function start() {
  ...
  var res = mainState ? parse(mainState) : {};
...
// EXTERNAL MODULE: ./src/App.vue + 15 modules
...
/******/ })["default"];
//# sourceMappingURL=sys-ui.common.js.map