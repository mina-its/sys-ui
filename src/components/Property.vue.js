...
let Property = class Property extends vue_property_decorator_1.Vue {
    render(ce) {
        ...
        switch (this.viewType) {
            ...
            case types_1.ObjectViewType.Filter:
    ...
    filterOperClick(e) {
        ...
        let items = oprs.map(opr => {
            return { ref: opr, title: main_2.$t(`opr-${opr}`) };
        });
        main_3.showCmenu(this, items, e, (state, item) => {
            if (item)
    ...
    renderValue(ce, styles) {
        ...
        switch (this.prop._.gtype) {
            ...
            case types_1.GlobalType.boolean:
                if (this.viewType == types_1.ObjectViewType.TreeView)
                    return null;
                if (this.viewType != types_1.ObjectViewType.GridView)
...
tslib_1.__decorate([
    vue_property_decorator_1.Emit('filterTitleClick')
], Property.prototype, "filterTitleClick", null);
