...
FormElem = tslib_1.__decorate([
    vue_property_decorator_1.Component({ name: 'form-elem', components: { AppChart: AppChart_vue_1.default, DocumentEditor: DocumentEditor_vue_1.default, ObjectView, Markdown: Markdown_vue_1.default } })
], FormElem);
