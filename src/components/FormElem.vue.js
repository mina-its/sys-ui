...
const Panel_vue_1 = tslib_1.__importDefault(require("@/components/Panel.vue"));
const ObjectView_vue_1 = tslib_1.__importDefault(require("@/components/ObjectView.vue"));
const Function_vue_1 = tslib_1.__importDefault(require("@/components/Function.vue"));
const DocumentEditor_vue_1 = tslib_1.__importDefault(require("@/components/DocumentEditor.vue"));
const AppChart_vue_1 = tslib_1.__importDefault(require("@/components/AppChart.vue"));
...
FormElem = tslib_1.__decorate([
    vue_property_decorator_1.Component({ components: { AppChart: AppChart_vue_1.default, DocumentEditor: DocumentEditor_vue_1.default, Function: Function_vue_1.default, ObjectView: ObjectView_vue_1.default, Panel: Panel_vue_1.default, Markdown: Markdown_vue_1.default, Prop: Prop_vue_1.default } })
], FormElem);
