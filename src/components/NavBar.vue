        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <div class="d-flex flex-wrap p-5" style="width: 50rem">
                    <a class="small m-3 business-app rounded border cursor-pointer" v-for="app of glob.config.businessApps" style="width: 8rem">
                        <div class="text-center p-2">
                            <div v-html="app.icon"></div>
                            <label class="py-2 font-weight-bold">{{app.title}}</label>
                        </div>
                    </a>
                </div>
            </div>
