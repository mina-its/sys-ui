...
let AppUserLoginMenu = class AppUserLoginMenu extends vue_property_decorator_1.Vue {
    goToSignout() {
        location.href = main_1.glob.config.user.signoutUrl + "?back=" + encodeURI(location.href);
    }
    goToSignin() {
        location.href = main_1.glob.config.user.signinUrl + "?back=" + encodeURI(location.href);
    }
    get profilePhoto() {
...
], AppUserLoginMenu.prototype, "buttonClass", void 0);
