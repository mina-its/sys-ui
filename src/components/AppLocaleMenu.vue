<template>
    <div class="app-locale-menu" data-toggle="tooltip" title="Change Language">
        <div v-if="glob.config.locale" class="dropdown">
            <a class="nav-link dropdown-toggle py-0 px-0 text-light" href="#" id="navbarDropdownLocale" role="button"
