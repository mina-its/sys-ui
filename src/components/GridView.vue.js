...
const GridViewRow_vue_1 = tslib_1.__importDefault(require("@/components/GridViewRow.vue"));
const FilterItem_vue_1 = tslib_1.__importDefault(require("@/components/FilterItem.vue"));
...
let GridView = class GridView extends vue_property_decorator_1.Vue {
    ...
    changed(e) {
        main.dispatchStoreModify(e.vue, {
    ...
    keydown(e) {
        ...
        switch (e.event.which) {
            ...
            case types_2.Keys.enter:
                let $t = jquery_1.default(e.event.target);
    ...
    showRowMenu(e) {
        ...
        if (e.item._id && main.getBsonId(e.item)) {
            if (this.root)
                items.unshift({ ref: 'tree', title: main_1.$t('tree-view') });
...
GridView = tslib_1.__decorate([
    vue_property_decorator_1.Component({
        components: { GridViewRow: GridViewRow_vue_1.default, FilterItem: FilterItem_vue_1.default }
    })
], GridView);
