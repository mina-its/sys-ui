...
let FileGallery = class FileGallery extends vue_property_decorator_1.Vue {
    ...
    removeFile(name) {
        main.question(null, `### Delete Confirm\n\nAre you sure you want to delete the file '${name}'`, [{ title: "YES", ref: types_1.YesNo.Yes }, { title: "NO", ref: types_1.YesNo.No }], (option) => {
            if (!option || option.ref == types_1.YesNo.No)
                return;
