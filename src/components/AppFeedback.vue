        ...
        <div class="dropdown-menu dropdown-menu-right filter-panel p-5" aria-labelledby="feedbackButton" style="width: 30rem">
            <form>
                <div v-if="showOverall">
                    ...
                    <div class="my-2 py-3">
                        <button title="Awful!" @click="postOverall('awful')" class="btn btn-link pl-0"><i class="fad fa-tired fa-2x" style="color: #F00"></i></button>
                        <button title="Not Good!" @click="postOverall('not-good')" class="btn btn-link"><i class="fad fa-frown fa-2x" style="color: #600"></i></button>
                        <button title="Average!" @click="postOverall('average')" class="btn btn-link"><i class="fad fa-meh fa-2x" style="color: #999"></i></button>
                        <button title="Good!" @click="postOverall('good')" class="btn btn-link"><i class="fad fa-smile fa-2x" style="color: #060"></i></button>
                        <button title="Perfect!" @click="postOverall('perfect')" class="btn btn-link"><i class="fad fa-laugh-beam fa-2x" style="color: #0A0"></i></button>
                    </div>
                </div>
